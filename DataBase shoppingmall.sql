...
insert into `Users` values ('user2', '계백', '19-06-11', 'M', '010-1102-1975', null, '1000', '1', '서울', now());
insert into `Users` values ('user3', '김춘추', '19-05-30', 'M', '010-1103-1989', null, '1200', '2', '서울', now());
insert into `Users` values ('user4', '이사부', '19-04-13', 'M', '010-2101-1979', 'leesabu@gmail.com', '2600', '1', '서울', now());
insert into `Users` values ('user5', '장보고', '19-09-12', 'M', '010-2104-1966', 'jangbg@naver.com', '9400', '4', '대전', now());
insert into `Users` values ('user6', '선덕여왕', '19-07-28', 'M', '010-3101-1979', 'queen@naver.com', '1600', '2', '대전', now());
insert into `Users` values ('user7', '강감찬', '19-06-15', 'F', '010-4101-1984', 'kang@daum.net', '800', '0', '대구', now());
insert into `Users` values ('user8', '신사임당', '19-10-21', 'M', '010-5101-1965', 'sinsa@gamil.com', '1500', '1', '대구', now());
insert into `Users` values ('user9', '이이', '19-11-28', 'F', '010-6101-1972', 'leelee@nate.com', '3400', '3', '부산', now());
insert into `Users` values ('user10', '허난설헌', '19-09-07', 'F', '010-7103-1992', null, '4100', '3', '광주', now());
