...
insert into `User5` values ('a101', '김유신',  1,  25, '김해시', '010-1234-1001');
insert into `User5` values ('a102', '김춘추',  1,  23, '경주시', '010-1234-1002');
...
#실습 2-13
alter table `user5` change column `addr` `addresss` varchar(100);
